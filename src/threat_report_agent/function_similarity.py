"""Compatibility shim: this module MOVED to `threat_report_agent.static.function_similarity`.
...
from threat_report_agent.static import function_similarity as _real
