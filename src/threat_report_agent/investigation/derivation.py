...
# MOVED to `emulation/policy.py` (P3.5-0 M-5) and re-exported with `X as X`, so every existing importer of
# `threat_report_agent.investigation.derivation.SimulationWindowOutcome` keeps the same object.
from threat_report_agent.emulation.policy import SimulationWindowOutcome as SimulationWindowOutcome  # noqa: E402
