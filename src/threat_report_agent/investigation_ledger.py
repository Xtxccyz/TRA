"""Compatibility shim: this module MOVED to `threat_report_agent.investigation.investigation_ledger`.
...
from threat_report_agent.investigation import investigation_ledger as _real
