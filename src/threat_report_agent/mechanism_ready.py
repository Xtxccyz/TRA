"""Compatibility shim: this module MOVED to `threat_report_agent.investigation.mechanism_ready`.
...
from threat_report_agent.investigation import mechanism_ready as _real
