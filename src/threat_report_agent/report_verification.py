"""Compatibility shim: this module MOVED to `threat_report_agent.report.report_verification`.
...
from threat_report_agent.report import report_verification as _real
