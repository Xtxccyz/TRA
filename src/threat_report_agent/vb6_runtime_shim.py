"""Compatibility shim: this module MOVED to `threat_report_agent.emulation.vb6_runtime_shim`.
...
from threat_report_agent.emulation import vb6_runtime_shim as _real
