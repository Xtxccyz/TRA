...
const result = spawnSync(tsx, ['--test', 'tests/session-event-bridge.test.ts', 'tests/session-scope-guard.test.ts', 'tests/session-scope-client.test.mjs', 'tests/pluginability-runtime.test.ts'], { cwd: workspace, stdio: 'inherit', shell: process.platform === 'win32' })
